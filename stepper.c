...
#else
		X_STEPPERS_DISABLE_PORT |= (1<<X_STEPPERS_DISABLE_BIT);
		Y_STEPPERS_DISABLE_PORT |= (1<<Y_STEPPERS_DISABLE_BIT);
		Z_STEPPERS_DISABLE_PORT |= (1<<Z_STEPPERS_DISABLE_BIT);
#endif
	} else {
#ifdef STEPPERS_DISABLE_PORT
		STEPPERS_DISABLE_PORT &= ~(1<<STEPPERS_DISABLE_BIT);
...
#else
  X_STEPPERS_DISABLE_DDR |= X_STEPPERS_DISABLE_MASK;
  Y_STEPPERS_DISABLE_DDR |= Y_STEPPERS_DISABLE_MASK;
  Z_STEPPERS_DISABLE_DDR |= Z_STEPPERS_DISABLE_MASK;
#endif
